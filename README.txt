...
You can click on the previous or next button to see the next shape. There are no duplicates but the next button might linger even when there
are no other shapes left. That has to do with the last shapes resulting in nothing thus why the buttons are there.
